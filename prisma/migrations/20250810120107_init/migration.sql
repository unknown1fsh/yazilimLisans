...
CREATE TABLE `OrderItem` (
    ...
    `licenseKeyId` INTEGER NULL,
    `productSnapshot` JSON NOT NULL,

    UNIQUE INDEX `OrderItem_licenseKeyId_key`(`licenseKeyId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `OrderItem` ADD CONSTRAINT `OrderItem_licenseKeyId_fkey` FOREIGN KEY (`licenseKeyId`) REFERENCES `LicenseKey`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
